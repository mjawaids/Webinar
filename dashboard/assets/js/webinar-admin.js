(function () {
    ...
    var app = angular.module('WebinarAdmin', ['ngCookies']);
    ...
    */
    app.controller('ScriptController',
        ['$http', '$rootScope', '$log', '$cookieStore', '$window', 'WSService',
        function ($http, $rootScope, $log, $cookieStore, $window, WSService) {

            /*
            * Validate session
            */
            if ($cookieStore.get('signin') != true) {
                $cookieStore.remove('signin');
